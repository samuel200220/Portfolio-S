      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div>
            ...
            <p className="max-w-2xl text-zinc-500">{t("description")}</p>
          </div>
                ...
                >
                  ...
                  <div className="relative p-6">
                    <div className="mb-3 flex items-start justify-between gap-4">
                      <h3 className="text-xl font-bold text-white transition-colors group-hover:text-neon-blue">{copy.title}</h3>
